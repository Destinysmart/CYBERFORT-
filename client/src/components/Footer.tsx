    ...
    <footer className="bg-white dark:bg-gray-800 py-4 shadow-inner">
      <div className="container mx-auto px-4 text-center">
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
          This tool analyzes URLs and phone numbers for potential threats using VirusTotal and AbstractAPI. While helpful, always exercise caution with unfamiliar websites and phone numbers.
        </p>
